...
@AnalyzeClasses(packagesOf = JhFisrtMicroServiceApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(JhFisrtMicroServiceApp.class), alwaysTrue())
